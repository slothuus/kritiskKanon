...
$config['mongo_db']['default']['username'] = 'admin123';
$config['mongo_db']['default']['password'] = 'admin123';
$config['mongo_db']['default']['database'] = 'kritikts_kanon';
...
/*Live mongodb configuration*/

$config['mongo_db']['default']['no_auth'] = TRUE;
$config['mongo_db']['default']['hostname'] = 'ds011158.mlab.com';
$config['mongo_db']['default']['port'] = '11158';
$config['mongo_db']['default']['username'] = 'kk_admin';
$config['mongo_db']['default']['password'] = 'kk_1234';
$config['mongo_db']['default']['database'] = 'kritiskkanon';
$config['mongo_db']['default']['db_debug'] = TRUE;
$config['mongo_db']['default']['return_as'] = 'array';
$config['mongo_db']['default']['write_concerns'] = (int)1;
$config['mongo_db']['default']['journal'] = TRUE;
