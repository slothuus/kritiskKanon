            ...
            <div class="col-md-12">                    
                  ...
                  <div class="box box-default">
                      <div class="embed-responsive embed-responsive-16by9">
                        <?php echo $game_intro_data[0]['intro_description'];?>
                      </div>                                    
                  </div>
      ...
      <section class="content game1_start" style="display: none !important">
        ...
        <div class="box box-default color-palette-box">
            <div class="box-body" style="padding: 0;">
                <div class="row fbox list origin_cls" id="origin">
                  ...
                  <div class="box3"></div>
                  <div class="box4"></div> 
                  <div class="boxes show image_show_data">
...
<script type="text/javascript">
  ...
  $("#drop").droppable({ accept: ".draggable", 
      drop: function(event, ui) {
          var $this = $(this);
          if($this.find('.draggable').length >= 3){
  ...
  $(".image_show_data").droppable({ accept: ".draggable", drop: function(event, ui) {
